...
from modules.acmilnetwork import Classifier_1fc, DimReduction, DimReduction1
...
class ACMIL_GA(nn.Module):
    def __init__(self, conf_ntoken=3,n_class=3,D_feat=1024,D_inner=512, D=128, droprate=0, n_token=3, n_masked_patch=10, mask_drop=0.6):
