...
import prompt.deepmil as mil_encoders
import prompt.clip as clip
import prompt.conch as conch
...
def load_vl_model_to_cpu(
    ...
    if api == 'CONCH':
        ...
        local_model_path='/home/shihuazhan/upload/conch.pt' #shz conch   /home/shihuazhan/upload /home/huangsheng/shihuazhan/pretrained/conch.pt
