...
#         train_loss,start,end = train_loop(args,Dit,model,model_tea,train_loader,optimizer,device,amp_autocast,criterion,loss_scaler,scheduler,k,mm_sche,epoch)
#         train_time_meter.update(end-start)
#         stop,accuracy, auc_value, precision, recall, fscore, test_loss, threshold_optimal = val_loop(args,Dit,model,val_loader,device,criterion,early_stopping,epoch,model_tea)

#         if model_tea is not None:
#             _,accuracy_tea, auc_value_tea, precision_tea, recall_tea, fscore_tea, test_loss_tea = val_loop(args,model_tea,val_loader,device,criterion,None,epoch,model_tea,Dit=Dit)
#             if args.wandb:
#                 rowd = OrderedDict([
...
#             _te_accuracy, _te_auc_value, _te_precision, _te_recall, _te_fscore,_te_test_loss_log = test(args,Dit,model,test_loader,device,criterion,model_tea)
...
#             if model_tea is not None:
#                 _te_tea_accuracy, _te_tea_auc_value, _te_tea_precision, _te_tea_recall, _te_tea_fscore,_te_tea_test_loss_log = test(args,Dit,model_tea,test_loader,device,criterion,model_tea)
...
#     accuracy, auc_value, precision, recall, fscore,test_loss_log = test(args,Dit,model,test_loader,device,criterion,model_tea,opt_thr)
...
# def train_loop(args,Dit,model,model_tea,loader,optimizer,device,amp_autocast,criterion,loss_scaler,scheduler,k,mm_sche,epoch):
...
#                 train_logits,cls_logits = model(bag,Dit)
#                 if args.loss == 'ce':
...
# def val_loop(args,Dit,model,loader,device,criterion,early_stopping,epoch,model_tea):
...
# def test(args,Dit,model,loader,device,criterion,model_tea=None,opt_thr=None):
#     if model_tea is not None:
#         model_tea.eval()
#     model.eval()
#     test_loss_log = 0.
